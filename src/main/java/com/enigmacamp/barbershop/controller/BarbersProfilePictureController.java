...
public class BarbersProfilePictureController {
    ...
    public ResponseEntity<CommonResponse<BarberProfilePicture>> create(@RequestBody MultipartFile image) {
        BarberProfilePicture barbersProfilePicture = (BarberProfilePicture) barbersProfilePictureService.create(image);
